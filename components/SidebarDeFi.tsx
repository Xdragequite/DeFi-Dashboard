...
function SidebarDeFi() {
  ...
  return (
    ...
    {/* Боковая панель */}
    <aside className={`inset-y-0 fixed rounded-b-xl w-52 bg-zinc-950 border-r border-b border-zinc-800/80 transform transition-transform duration-300 ease-in-out 
  ...
  <div className='flex h-16 items-center justify-between px-6 bg-zinc-900/40 border-b border-zinc-800/60 text-white gap-12'>
    ...
    >
      <Menu size={24} className={`absolute transition-all duration-300 ease-in-out 
